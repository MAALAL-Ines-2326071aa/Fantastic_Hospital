...
public class Creature {
    ...
    public static Creature creerCreature(String type, String nom, String sexe, int moral, int poids, int age, Maladie maladie) {
        switch (type) {
            ...
            case "Lycanthrope":
                return new Lycanthrope(type,nom, sexe, moral, poids, age, maladie, Math.random()>0.5 ? "jeune":"vieux", (int) (Math.random()*10),(int) (Math.random()*10), poids<0.5 ? "omega": "beta", (int) (Math.random()*10) );
            case "Orque":
